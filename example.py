...
def house():
    input_path = 'images/house/'
    camera_filepath = 'images/house/3D/house.00{0}.P'
...
def dino():
    # Dino
    img1 = cv2.imread('images/dinos/viff.003.ppm')
    img2 = cv2.imread('images/dinos/viff.001.ppm')
...
if __name__ == "__main__":
    ...
    ## 1.基于SIFT方法计算两张图片的匹配关键点
    points1, points2, intrinsic = dino()

    ## 2.计算基础矩阵（fundamenta matrix）和本质矩阵（essential matrix） E = K_2^T F K_1
